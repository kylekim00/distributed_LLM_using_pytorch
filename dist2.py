...
class FullNode:
    ...
    #         if self.recv_control:
    #             r_ctl = self.recv_buffer.get_next_tensor()
    #             x = self.recv_buffer.get_next_tensor()

            
    #         if r_ctl and s_ctl:
    #             s_ctl.copy_(r_ctl)#do something later on.
    ...
    #         if x is None and out is not None:
    #             out.copy_(func(x))
    #         elif x is not None:
    #             return func(x, *args, **kwargs)
    #         elif out is not None:
    #             out.copy_(func(*args, **kwargs))
    #         else:
